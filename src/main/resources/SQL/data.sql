...
INSERT INTO projects (user_id, title, description, is_public, github_url) VALUES
                                                                              ...
                                                                              (1, 'Платформа онлайн-обучения', 'Публичная платформа для проведения онлайн-курсов и вебинаров.', TRUE, 'http://github.com/superadmin/online-learning'),
...
VALUES
    ...
    (1, 'Запуск платформы', 'Платформа онлайн-обучения успешно запущена, первые пользователи уже зарегистрировались.', TRUE);
